...
var Texture = /*#__PURE__*/function (_Resource) {
  ...
  _createClass(Texture, [{
    ...
    value: function initialize() {
      ...
      (0, _contextState.withParameters)(this.gl, glSettings, function () {
    ...
    value: function subImage(_ref3) {
      ...
      if (compressed) {
        ...
        (0, _assert2.default)((0, _context.isWebGL2)(this.gl), _context.ERR_WEBGL2);
        // This texImage2D signature uses currently bound GL_PIXEL_UNPACK_BUFFER
        this.gl.bindBuffer(_glConstants2.default.PIXEL_UNPACK_BUFFER, data);
        this.gl.texSubImage2D(target, level, format, width, height, border, format, type, offset);
        this.gl.bindBuffer(_glConstants2.default.GL_PIXEL_UNPACK_BUFFER, null);
      } else {
    ...
    key: 'copyFramebuffer',
    value: function copyFramebuffer(_ref4) {
      var _ref4$target = _ref4.target,
          target = _ref4$target === undefined ? this.target : _ref4$target,
          framebuffer = _ref4.framebuffer,
          ...
          internalFormat = _ref4$internalFormat === undefined ? _glConstants2.default.RGBA : _ref4$internalFormat,
    ...
    key: 'setImageData',
    value: function setImageData(_ref5) {
      var _ref5$target = _ref5.target,
          target = _ref5$target === undefined ? this.target : _ref5$target,
          _ref5$pixels = _ref5.pixels,
          pixels = _ref5$pixels === undefined ? null : _ref5$pixels,
          ...
          format = _ref5$format === undefined ? _glConstants2.default.RGBA : _ref5$format,
          type = _ref5.type,
          ...
          compressed = _ref5$compressed === undefined ? false : _ref5$compressed;
