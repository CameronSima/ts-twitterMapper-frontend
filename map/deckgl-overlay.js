...
export default class DeckGLOverlay extends Component {
  ...
  _animate() {
    ...
    // wait to start animation so that all data are loaded
    this.startAnimationTimer = window.setTimeout(this._startAnimate, 10000);
  }
  ...
  render() {
    ...
    const layers = [
      new CustomHexLayer({
        ...
        opacity: 1,
        pickable: Boolean(this.props.onClick),
        radius,
        upperPercentile
      })
    ];
