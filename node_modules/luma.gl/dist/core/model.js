...
var Model = /*#__PURE__*/function (_Object3D) {
  ...
  _createClass(Model, [{
    ...
    value: function _initializeProgram(_ref2) {
      ...
      if (!vs) {
        vs = modules ? _shaders.MODULAR_SHADERS.vs : _shaders.MONOLITHIC_SHADERS.vs;
      }
      if (!fs) {
        fs = modules ? _shaders.MODULAR_SHADERS.fs : _shaders.MONOLITHIC_SHADERS.fs;
      }
      ...
      var getUniforms = void 0;
      if (modules && typeof vs === 'string' && typeof fs === 'string') {
        var _assembleShaders = (0, _shadertools.assembleShaders)(this.gl, { vs: vs, fs: fs, modules: modules, defines: defines });

        vs = _assembleShaders.vs;
        fs = _assembleShaders.fs;
        getUniforms = _assembleShaders.getUniforms;
      }
    ...
    value: function draw() {
      ...
      if (framebuffer) {
        settings = Object.assign(settings, { framebuffer: framebuffer });
      }
      return (0, _webgl.withParameters)(gl, settings, function () {
